...
public class AsyncHttpClient {
	...
	private static final String USER_AGENT_PREFIX = "EEN Android App ";
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpProtocolParams.setUserAgent(httpParams, String.format(USER_AGENT_PREFIX + "android-async-http/%s (http://loopj.com/android-async-http)", VERSION));
